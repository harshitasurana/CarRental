            ...
            <form action="" onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
                ...
                <div className='flex items-center gap-2 w-full'>
                    <label htmlFor="car-image">
                        ...
                        <input type="file" onChange={(e) => setImage(e.target.files[0])} id='car-image' accept='image/*' hidden />
                    </label>
                ...
                <div className='flex flex-col w-full'>
                    ...
                    <select onChange={e => setCar({ ...car, location: e.target.value })} value={car.fuel_type} className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'>
                ...
                <div className='flex flex-col w-full'>
                        ...
                        <textarea rows={5} placeholder='' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.description} onChange={e => setCar({ ...car, description: e.target.description })} ></textarea>
                    </div>
